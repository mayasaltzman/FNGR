      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final docs = snapshot.data!.docs
              .where((doc) => doc.id != _firebaseService.currentUserId)
              .toList();
          if (docs.isEmpty) {
            return const Center(child: CircularProgressIndicator());
          }
              ...
              return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => UserProfilePage(userId: uid)),
                    );
                  },
                  child: Semantics(
                    container: true,
                          ...
                          Expanded(
                            child: ClipRRect(
                                ...
                                child: Semantics(
                                  image: true,
                                  label:
                                      "user image", //this should be alt text if provided if not user image
